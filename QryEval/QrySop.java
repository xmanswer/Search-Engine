...
public abstract class QrySop extends Qry {
	/**
	 *  scoreCache caches the score from the matched docid so that
	...
	public void setScoreCache(double scoreCache) {
		this.scoreCache = scoreCache;
	}
	
	/**
	 *  Get a default score for the document if the global min docid does not
	 *  match the current docid or the current list has no match any more
	 *  Used for Indri model, supports #and
	 *  @param r The retrieval model that determines how scores are calculated.
	 *  @return The document score.
	 *  @throws IOException Error accessing the Lucene index
	 */
